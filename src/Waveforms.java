...
public class Waveforms {
    ...
    public static void main(String[] args) throws IOException {
        ...
        Envelope e = new Envelope(m440s1,2000000, 1000000, .3f, 2000000);
        e.setDuration(9000000);
        System.out.println(e.getSustainPeriod());

        // Plot
        PrintStream ps = new PrintStream(new FileOutputStream(new File("check.csv")));
        for(int i = 0;i < (Inherit.MICROSECONDS_IN_A_SECOND*15);i += 1000) {
